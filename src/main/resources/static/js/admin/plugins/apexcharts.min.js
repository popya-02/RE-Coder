...
!function (t, e) {
    ...
    var C = {
        ...
        return r(t, [{
            ...
            key: "setXRange", value: function () {
                ...
                if (t.isXNumeric && function () {
                    ...
                    } else t.xAxisScale = this.scales.setXScale(t.minX, t.maxX); else t.xAxisScale = this.scales.linearScale(0, a, a), t.noLabelsProvided && t.labels.length > 0 && (t.xAxisScale = this.scales.linearScale(1, t.labels.length, a - 1), t.seriesX = t.labels.slice());
        ...
        for (var e = "", i = 0; i < t.length; i++) {
            var a = t[i], s = t[i - 1], r = a.length, o = null == s ? void 0 : s.length;
        ...
        return r(t, [{
            key: "draw", value: function (t, i, a, s) {
                ...
                for (var d = [], g = 0; g < t.length; g++) {
                    ...
                    if ("rangeArea" === l) {
                        var C = this._calculatePathsFrom({series: s, i: g, realIndex: u, prevX: v, prevY: k}),
            ...
            key: "_iterateOverDataPoints", value: function (t) {
                var e = this, i = t.type, a = t.series, s = t.iterations, r = t.realIndex, o = t.i, n = t.x, l = t.y,
                    h = t.pathsFrom, c = t.linePaths, d = t.areaPaths, g = t.seriesIndex, u = t.lineYPosition,
                    p = t.xArrj, f = t.yArrj, b = t.y2Arrj, v = t.isRangeStart, y = t.seriesRangeEnd, w = this.w,
                    k = new m(this.ctx), A = this.yRatio, S = h.prevY, C = h.linePath, L = h.areaPath,
                    P = h.pathFromLine, I = h.pathFromArea,
                ...
                for (var M = function (t, i) {
                    ...
                    if (w.config.chart.stacked) if (o > 0 && w.globals.collapsedSeries.length < w.config.series.length - 1) {
                    ...
                    } else u = this.zeroY; else u = this.zeroY;
            ...
            key: "_createPaths", value: function (t) {
                var e = t.type, i = t.series, a = t.i, s = t.realIndex, r = t.j, o = t.x, n = t.y, l = t.xArrj,
                    h = t.yArrj, c = t.y2, d = t.y2Arrj, g = t.linePath, u = t.areaPath, p = t.linePaths,
                    f = t.areaPaths, x = t.seriesIndex, b = t.isRangeStart, v = this.w, y = new m(this.ctx),
                    w = v.config.stroke.curve, k = this.areaBottomY;
                ...
                return {linePaths: p, areaPaths: f, linePath: g, areaPath: u}
            }
        }, {
